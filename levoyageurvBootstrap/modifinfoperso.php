			...
			<form role="form" action="" method="post" >
				<div class="col-lg-8 col-lg-offset-2">
					...
					<div class="form-group">
                         <label  for="InputName " class="  col-lg-4">cin</label>
                        
						<div class="input-group col-lg-8 pull-rigth ">
						...
						<div class="form-group">
						<label for="InputName "class="  col-lg-4">nom</label>
						<div class="input-group col-lg-8 pull-rigth">
						...
						<div class="form-group">
							<label for="InputEmail"class="  col-lg-4">prenom</label>
							<div class="input-group col-lg-8 pull-rigth">
							...
							<div class="form-group">
								<label for="InputMessage" class="  col-lg-4">adresse</label>
								<div class="input-group col-lg-8 pull-rigth">
							...
							<div class="form-group">
								<label for="InputMessage"class="  col-lg-4">telephone</label>
								<div class="input-group col-lg-8 pull-rigth">
							...
							<div class="form-group">
								<label for="InputMessage"class="  col-lg-4">email</label>
								<div class="input-group col-lg-8 pull-rigth">
							...
							<div class="form-group">
								<label for="InputMessage"class="  col-lg-4">login</label>
								<div class="input-group col-lg-8 pull-rigth">
							...
							<div class="form-group">
								<label for="InputMessage" class="  col-lg-4">mdp</label>
								<div class="input-group col-lg-8 pull-rigth">

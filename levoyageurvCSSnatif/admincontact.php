                ...
                <?php
                        ...
                        if ($result = $mysqli->query("SELECT * FROM contact ORDER BY id_con"))
                        {
                                ...
                                if ($result->num_rows > 0)
                                {
                                        ...
                                        // set table headers
                                        echo "<tr><th>ID</th> <th>ID client</th><th>mail</th><th>Objet</th><th>sujet</th><th>Action</th></tr>";
                                        ...
                                        while ($row = $result->fetch_object())
                                        {
                                                ...
                                                echo "<td><a href='repondrecontact.php?idclt=" . $row->idclt . "'>repondre</a></td>";
                                                echo "<td><a href='deleteconact.php?id_con=" . $row->id_con . "'>Delete</a></td>";
                                                echo "</tr>";
                                        }
